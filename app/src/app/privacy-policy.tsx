		...
		<SafeAreaView className="flex-1 bg-black">
			...
			>
				...
				>
					...
					<SectionText>
						Welcome to KIIT TIME, a timetable application designed for KIIT
						students. We prioritize your privacy and are committed to
						safeguarding your personal information. This Privacy Policy outlines
						how we collect, use, and protect your data when you use our app.
					</SectionText>

					<SectionTitle>2. Information We Collect</SectionTitle>
					<InfoPoint
						title="Personal Information"
						content="We collect your roll number to retrieve and display your specific timetable."
					/>
					<InfoPoint
						title="Usage Data"
						content="We collect information on how you interact with the app to improve our services."
					/>

					<SectionTitle>3. Use of Information</SectionTitle>
					<InfoPoint
						title="Timetable Retrieval"
						content="Your roll number is used to fetch your timetable from our backend services."
					/>
					<InfoPoint
						title="App Improvement"
						content="Usage data helps us enhance app performance and user experience."
					/>

					<SectionTitle>4. Data Storage and Security</SectionTitle>
					<InfoPoint
						title="Local Storage"
						content="Your timetable is stored locally on your device to ensure access without an internet connection."
					/>

					<SectionTitle>5. Third-Party Services</SectionTitle>
					<InfoPoint
						title="Supabase"
						content="We use Supabase for backend services, which may collect data as per their privacy policies."
					/>

					<SectionTitle>6. User Rights</SectionTitle>
					<InfoPoint
						title="Access and Correction"
						content="You can access and update your personal information within the app."
					/>
					<InfoPoint
						title="Data Deletion"
						content="You can request the deletion of your data by contacting us."
					/>
