...
export async function sendOtp(rollNo: string, sectionIds: number[]): Promise<{ status: string; message: string }> {
...
export async function verifyOtp(rollNo: string, otpCode: string): Promise<RollNumberMappingOut> {
